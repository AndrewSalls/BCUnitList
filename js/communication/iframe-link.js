...
export const REQUEST_TYPES = {
    UPDATE_ID: (/** @type {import("../data/unit-data").UNIT_RECORD} */ unit) => /** @type {Promise<void>} */ (makeRequest(RESPONSE_TYPES.UPDATE_UNIT, unit)),
    ...
    IS_ANY_UNFILTERED: (/** @type {number[]} */ idList, /** @type {boolean} */ ignoreFilters = false) => /** @type {Promise<boolean>} */ (makeRequest(RESPONSE_TYPES.IS_ANY_UNFILTERED, { target: idList, dataType: UNIT_DATA_TYPE.UNIT }, ignoreFilters)),
    ...
    UPDATE_ABILITY: (/** @type {number} */ index, /** @type {number} */ level, /** @type {number} */ plusLevel) => /** @type {Promise<void>} */ (makeRequest(RESPONSE_TYPES.UPDATE_ABILITY, { id: index, level: level, plus: plusLevel })),
    ...
    SEND_ALERT: (/** @type {string} */ message, /** @type {boolean} */ isError) => /** @type {Promise<void>} */ (makeRequest(RESPONSE_TYPES.DISPLAY_MESSAGE, { message: message, isError: isError })),
    DELETE_USER_DATA: (/** @type {string} */ message, /** @type {boolean} */ isError) => /** @type {Promise<void>} */ (makeRequest(RESPONSE_TYPES.DELETE_USER_DATA, { message: message, isError: isError }))
}
